...
public class PerfUtil {
    ...
    public enum MAXINE_PERF_EVENT_GROUP_ID {
        ...
        L1_WRITES_SINGLE(26),
        LLC_READS_SINGLE(27),
        LLC_WRITES_SINGLE(28),
        LLC_READ_MISSES_SINGLE(29),
        LLC_WRITE_MISSES_SINGLE(30),
        NODE_READ_MISSES_SINGLE(31),
        NODE_WRITE_MISSES_SINGLE(32),
        LLC_PREFETCH_SINGLE(33),
        LLC_PREFETCH_MISSES_SINGLE(34),
        NODE_PREFETCH_SINGLE(35),
        NODE_PREFETCH_MISSES_SINGLE(36);
    ...
    public enum MAXINE_PERF_EVENT_ID {
        ...
        HW_CACHE_LLC_PREFETCH(41),
        HW_CACHE_LLC_PREFETCH_MISSES(42),
        HW_CACHE_NODE_PREFETCH(43),
        HW_CACHE_NODE_PREFETCH_MISSES(44),

        HW_CACHE_DTLB_READS(45),
        HW_CACHE_DTLB_WRITES(46),
        HW_CACHE_DTLB_READ_MISSES(47),
        HW_CACHE_DTLB_WRITE_MISSES(48);
