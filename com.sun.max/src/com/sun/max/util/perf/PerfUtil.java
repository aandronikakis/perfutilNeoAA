...
public class PerfUtil {
    ...
    public enum MAXINE_PERF_EVENT_GROUP_ID {
        ...
        L1_WRITES_SINGLE(22),
        LLC_READS_SINGLE(23),
        LLC_WRITES_SINGLE(24),
        LLC_READ_MISSES_SINGLE(25),
        LLC_WRITE_MISSES_SINGLE(26),
        NODE_READ_MISSES_SINGLE(27),
        NODE_WRITE_MISSES_SINGLE(28),
        LLC_PREFETCH_SINGLE(29),
        LLC_PREFETCH_MISSES_SINGLE(30),
        NODE_PREFETCH_SINGLE(31),
        NODE_PREFETCH_MISSES_SINGLE(32);
